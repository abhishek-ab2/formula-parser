...
formulas = {'ADVANCE': '0',
 'BASIC': 'min(([CTC]-[EMPLOYER_PF]), if([EMPLOYEE_PF], if([CTC]<13000,[CTC]-[EMPLOYER_PF], max(13000,[CTC]*0.51)),if([CTC]<15100,[CTC],max(15100,[CTC]*0.51))',
...
try:
    res = parse_formula(
            ...
            val,
            {
                'EMPLOYEE_ESIC_APPLICABLE': False,
                'EMPLOYEE_FPF_DEDUCTION': False,
                'EMPLOYEE_HIGHER_PF': False,
                'EMPLOYEE_PF': True,
                'EMPLOYEE_PF_PERCENT': 8,
                'EMPLOYEE_PT_APPLICABLE': True,
                'EMPLOYEE_WAGE_LIMIT_COMPANY': False,
                'EMPLOYEE_WAGE_LIMIT_EMPLOYEE': False
            }
    )
